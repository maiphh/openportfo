...
export default function ChatLauncher({ open, ready, reducedMotion, hidden = false, viewportOffset, dragging, position, onClick, onPointerDown, onPointerMove, onPointerUp, onPointerCancel, buttonRef }: ChatLauncherProps) {
  return (
    <button
      ...
      className="chat-launcher fixed left-0 top-0 z-[51] inline-flex size-14 touch-none items-center justify-center rounded-full border border-teal-200/50 bg-teal-400 text-teal-950 shadow-xl shadow-teal-950/45 focus:outline-none focus:ring-2 focus:ring-teal-200 focus:ring-offset-2 focus:ring-offset-gray-900"
