...
| BL-035 | HTTP API Gateway proxy for Beanstalk `/api/*` REST (chat SSE stays on EB) | P0 | `done` | Eng | `features/BL-035-api-gateway.md` | SA `approve` 2026-09-13; **live 2026-09-13**: Gateway `7duvngr98b` (`ANY /api/{proxy+}` → EB), EB `v-20260913-http-api` Ready/Green, 4 EventBridge rules ENABLED (see BL-038) |
| BL-038 | Refresh stale deploy docs (Lambda + API Gateway live 2026-09-13) | P1 | `done` | Eng | `features/BL-038-deploy-docs-refresh.md` | SA `approve` 2026-09-13; docs-only, `main` working tree, review-ready, no commit |
...
|----|-------|-----------|--------------|
| BL-038 | Refresh stale deploy docs (Lambda + API Gateway live) | 2026-09-13 | `features/BL-038-deploy-docs-refresh.md` |
